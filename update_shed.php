...
<head>
    ...
    <title>IFSS | Update Schedule</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                         <h4 class="page-title">Update Schedules</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li><a href="#">Admin</a></li>
                            <li><a href="#">Schedules</a></li>
                            <li class="active">Update Existing</li>
                        </ol>
                    </div>
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control">
                                    ...
                                    <option selected="">McConell, Tracy</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" style="text-align: right;">
                                <p>Temporary Substitution: 12</p>
                            </div>
                            <div class="col-md-2" style="text-align: right;">
                                <p>Total Units Used: 24</p>
                            </div>
                        </div>
